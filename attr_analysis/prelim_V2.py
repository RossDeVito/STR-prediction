...
if __name__ == '__main__':
	...
	# # Plot means for tp and tn groups
	# fig, axs = plt.subplots(2, 2, figsize=(20, 8))
	# plot_heatmap_in_axs(
	# 	tp_data['pre'].mean(axis=0),
	# 	tp_data['post'].mean(axis=0),
	# 	axs[0],
	# 	'guided backprop TP mean'
	# )
	# plot_heatmap_in_axs(
	# 	tn_data['pre'].mean(axis=0),
	# 	tn_data['post'].mean(axis=0),
	# 	axs[1],
	# 	'guided backprop TN mean'
	# )
	# if save_plots:
	# 	plt.savefig(
	# 		os.path.join(
	# 			plot_save_dir, 
	# 			'means_TP_TN_{}.png'.format(attr_file.split('.')[0])
	# 		)
	# 	)
	# plt.show()
	...
	# # plot top 5 TPs
	# top_n = 50
	# tp_inds = np.argsort(-tp_data['predictions'])[:top_n]
	...
	# 		os.path.join(
	# 			plot_save_dir, 
	# 			'top_{}_TPs_{}.png'.format(top_n, attr_file.split('.')[0])
	# 		)
	# 	)
	# if show_plots:
	# 	plt.show()
	...
	# # plot top n TNs
	# tn_inds = np.argsort(tn_data['predictions'])[:top_n]
	# fig, axs = plt.subplots(
	# 	top_n, 
	# 	3, 
	# 	figsize=(20, .9*top_n),
	...
	# 		os.path.join(
	# 			plot_save_dir, 
	# 			'top_{}_TNs_{}.png'.format(top_n, attr_file.split('.')[0])
	# 		)
	# 	)
	# if show_plots:
	# 	plt.show()

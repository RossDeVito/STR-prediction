...
from models import ConcatPredictorBert, STRPrePostRegressor
...
if __name__ == '__main__':
	models_to_eval = [
		# {   'name': 'Inception v1 (4,2), bs64',
		# 	'model': InceptionPrePostModel(),
		# 	'load_path': '../trained_models/repeat_num/version_0/checkpoints/epoch=0-best_val_loss.ckpt'
		# },
		{   'name': 'Inception v1 (4,2), bs128',
			'model': InceptionPrePostModel(),
			'load_path': '../trained_models/repeat_num/version_1/checkpoints/epoch=25-last.ckpt'
		},
	]
	...
	for m in models_to_eval:
		model = STRPrePostRegressor.load_from_checkpoint(
			m['load_path'],
			model=m['model']
		)

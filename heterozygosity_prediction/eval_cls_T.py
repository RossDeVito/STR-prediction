...
if __name__ == '__main__':
	...
	models_to_eval = [
		{   'name': 'Inception 0 ((3,32),(1,32)) [5,9,19]',
			...
			'load_path': '../trained_models/het_cls_v2/round3/V2_1_T/version_0/checkpoints/epoch=66-best_val_loss.ckpt'
		},
		{   'name': 'Inception 1 ((5,64),(2,64)) [5,9,19]',
			...
			'load_path': '../trained_models/het_cls_v2/round3/V2_1_T/version_1/checkpoints/epoch=37-best_val_loss.ckpt'
		},
		{   'name': 'Inception 2 ((5,64),(2,64)) [5,9,19] le1e-5',
			'model': InceptionPrePostModel(
				in_channels=num_feat_channels,
				depth_fe=5,
				n_filters_fe=64,
			...
			'load_path': '../trained_models/het_cls_v2/round3/V2_1_T/version_2/checkpoints/epoch=367-best_val_loss.ckpt'
		},
		{   'name': 'Inception 3 ((5,64),(2,64)) [5,9,19] pw.8',
			'model': InceptionPrePostModel(
				in_channels=num_feat_channels,
				depth_fe=5,
				n_filters_fe=64,
			...
			'load_path': '../trained_models/het_cls_v2/round3/V2_1_T/version_3/checkpoints/epoch=36-best_val_loss.ckpt'
		},
		{   'name': 'Inception 4 ((3,32),(1,32)) [5,9,19] pw.8',
			'model': InceptionPrePostModel(
				in_channels=num_feat_channels,
				depth_fe=3,
				n_filters_fe=32,
			...
			'load_path': '../trained_models/het_cls_v2/round3/V2_1_T/version_4/checkpoints/epoch=29-best_val_loss.ckpt'
		},
	]
	...
	fig.savefig('../trained_models/het_cls_v2/round3/V2_1_T/roc_pr.png',
				bbox_inches='tight')
	plt.close(fig)
	...
	# fig.tight_layout()
	fig.savefig('../trained_models/het_cls_v2/round3/V2_1_T/CMs.png',
				bbox_inches='tight')
	plt.close(fig)
	...
	table.to_csv('../trained_models/het_cls_v2/round3/V2_1_T/table.csv')
